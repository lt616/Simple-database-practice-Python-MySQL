# COMP4111 Assignment 01 - top 10 hitter for CSV implementation  
...
db_people = CSVTable("People", "People.csv", primary_keys)
db_people.load() 

primary_keys = ["playerID", "yearID", "teamID", "stint"]
db_batting = CSVTable("Batting", "Batting.csv", primary_keys)
db_batting.load() 
